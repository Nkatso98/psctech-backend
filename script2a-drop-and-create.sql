DROP PROCEDURE IF EXISTS dbo.sp_create_study_session;
GO
...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Declare variable to store the new ID
        DECLARE @NewId UNIQUEIDENTIFIER = NEWID();
        
        -- Insert the study session
        INSERT INTO dbo.StudySessions(Id, UserId, InstitutionId, Subject, Topic, DayOfWeek, StartTime, DurationMinutes, ReminderMinutesBefore, IsActive)
        VALUES (@NewId, @userId, @institutionId, @subject, @topic, @dayOfWeek, @startTime, @durationMinutes, @reminderMinutesBefore, 1);
