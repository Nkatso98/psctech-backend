...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Generate new ID for redemption record
        DECLARE @RedemptionId UNIQUEIDENTIFIER = NEWID();
        ...
        INSERT INTO dbo.voucher_redemptions(id, voucher_id, voucher_code, user_id, parent_guardian_name, learner_count)
        VALUES (@RedemptionId, @VoucherIdValue, @voucherCode, @userId, @parentGuardianName, @learnerCount);
