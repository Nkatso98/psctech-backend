...
BEGIN
    ...
    BEGIN TRY
        ...
        -- Insert the voucher
        INSERT INTO dbo.vouchers(id, voucher_code, denomination, parent_guardian_name, learner_count, institution_id, issued_by_user_id, expires_at)
        VALUES (@NewId, @VoucherCodeValue, @denomination, @parentGuardianName, @learnerCount, @institutionId, @issuedByUserId, DATEADD(month, 12, GETUTCDATE()));
