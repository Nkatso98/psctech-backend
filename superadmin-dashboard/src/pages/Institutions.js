...
function Institutions() {
    var _this = this;
    var _a = (0, react_1.useState)([]), institutions = _a[0], setInstitutions = _a[1];
    ...
    var loadInstitutions = function () { return __awaiter(_this, void 0, void 0, function () {
        var data, error_1, mockInstitutions;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, 3, 4]);
                    setLoading(true);
                    return [4 /*yield*/, api_client_1.apiClient.getInstitutions()];
                case 1:
                    data = _a.sent();
                ...
                case 2:
                    error_1 = _a.sent();
                    console.error('Error loading institutions:', error_1);
                    mockInstitutions = [
                        {
                            id: '1',
    ...
    var filteredInstitutions = institutions.filter(function (institution) {
        var matchesSearch = institution.name.toLowerCase().includes(searchTerm.toLowerCase()) ||
            institution.district.toLowerCase().includes(searchTerm.toLowerCase());
        var matchesStatus = statusFilter === 'all' || institution.status === statusFilter;
        var matchesType = typeFilter === 'all' || institution.type === typeFilter;
    ...
    var getSubscriptionBadge = function (status) {
        switch (status) {
            case 'Active':
                return <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-success-100 text-success-800">
          Active
      ...
      <div className="card">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <select value={typeFilter} onChange={function (e) { return setTypeFilter(e.target.value); }} className="input-field">
        ...
        <div className="overflow-x-auto">
          <table className="min-w-full divide-y divide-gray-200">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredInstitutions.map(function (institution) { return (<tr key={institution.id} className="hover:bg-gray-50">
