# =====================================================
# DEPLOY VOUCHER API TO AZURE APP SERVICE
# =====================================================

Write-Host "🚀 Starting Voucher API deployment to Azure..." -ForegroundColor Green

# Configuration
$resourceGroup = "psctech-rg"
$appServiceName = "psctech-voucher-api"
$location = "South Africa North"
$runtime = "dotnet:8.0"
$zipPath = "voucher-api-deploy.zip"
...
if ([string]::IsNullOrEmpty($appServiceExists)) {
    ...
    $planName = "$resourceGroup-voucher-plan"
...
# Build the project
Write-Host "🔨 Building Voucher API project..." -ForegroundColor Yellow
...
# Publish the project
Write-Host "📦 Publishing Voucher API..." -ForegroundColor Yellow
...
Write-Host "🌐 Voucher API deployed successfully!" -ForegroundColor Green
...
Write-Host "   Voucher Endpoints:" -ForegroundColor White
Write-Host "     - POST $fullUrl/api/voucher/create" -ForegroundColor White
Write-Host "     - GET $fullUrl/api/voucher/{id}" -ForegroundColor White
Write-Host "     - GET $fullUrl/api/voucher/institution/{institutionId}" -ForegroundColor White
Write-Host "     - POST $fullUrl/api/voucher/redeem" -ForegroundColor White
...
Write-Host "🎉 Voucher API deployment completed!" -ForegroundColor Green
Write-Host "   Your Voucher API is now live at: $fullUrl" -ForegroundColor White
